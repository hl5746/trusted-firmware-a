...
/*
 * Voltage Level defiantion for RPM rails
 *
 * Please don't change current exiting enum values for the defined corners.
 * Newly added corners need to be defined with new enum values without changing the existing values.
 *
